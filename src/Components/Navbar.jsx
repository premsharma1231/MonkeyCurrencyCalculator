    ...
    <>
        ...
        <div className="flex bg-Newone justify-between h-20 items-center px-4">
            ...
            <div className="flex list-none">
                <Link  to="/" onClick={()=> universalNavbar('HOME')} className={`${colorChanging === "HOME" ? "text-white" : "text-CalcGreenText"} p-2 transition-all text-1xl hover:cursor-pointer font-Karla font-bold`}>HOME</Link>
                ...
                <Link  to="/liverates" onClick={()=> universalNavbar("LIVE RATES")} className={`${colorChanging === "LIVE RATES" ? "text-white" : "text-CalcGreenText"} p-2 transition-all text-1xl hover:cursor-pointer font-Karla font-bold`}>LIVE RATES</Link>
            </div>
